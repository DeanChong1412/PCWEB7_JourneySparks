...
export default function PostPageAdd() {
  ...
  async function addPost() {
    ...
    await addDoc(collection(db, "posts"), { caption, image: imageUrl, imageName: imageName, rating, });
    navigate("/");
  }
      ...
      <Container>
        ...
        <Form>
          <Form.Group className="mb-3" controlId="caption">
            ...
            <Form.Control
              type="text"
              placeholder="Country / State / Location"
              value={caption}
          ...
          <Form.Group className="mb-3" controlId="rating">
            ...
            <ReactStars
              count={5}
              size={24}
              onChange={(newRating) => setRating(newRating)} // You can replace console.log with a state setter for rating
              value={0} // Initial value, replace with state value for rating if needed
